            ...
            <div className='col-md-8 m-auto'>
              ...
              <form onSubmit={this.onSubmit}>
                <div className='form-group'>
                  <input type='text' className='form-control form-control-lg ' placeholder='Project Name' name='projectName' value={projectName} onChange={this.onChange} />
                </div>
                <div className='form-group'>
                  <input type='text' className='form-control form-control-lg' placeholder='Unique Project ID' name='projectIdentifier' value={projectIdentifier} onChange={this.onChange} />
                </div>
                <div className='form-group'>
